...
if __name__ == "__main__":
 #unner = Runner()
 #unner.bench_func("const valid", lambda: const.is_valid(valid))
 #unner.bench_func("const invalid", lambda: const.is_valid(invalid))
 #unner.bench_func("enum valid", lambda: enum.is_valid(valid))
 #unner.bench_func("enum invalid", lambda: enum.is_valid(invalid))
