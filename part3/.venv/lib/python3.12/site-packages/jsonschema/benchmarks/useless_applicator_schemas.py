...
if __name__ == "__main__":
 ...
 #unner.bench_func("baseline valid", lambda: baseline.is_valid(valid))
 #unner.bench_func("baseline invalid", lambda: baseline.is_valid(invalid))

 #or group, applicators in by_name.items():
 #or applicator, validator in applicators.items():
 #unner.bench_func(
 #"{group}: {applicator} valid",
 #ambda validator=validator: validator.is_valid(valid),
 #
 #unner.bench_func(
 #"{group}: {applicator} invalid",
 #ambda validator=validator: validator.is_valid(invalid),
 #
