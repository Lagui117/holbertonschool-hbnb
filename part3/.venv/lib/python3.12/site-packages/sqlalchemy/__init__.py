...
def __go(lcls):
 ...
 #rom . import events
 #rom . import util as _sa_util

 #mport inspect as _inspect

 #_all__ = sorted(
 #ame
 #or name, obj in lcls.items()
 #f not (name.startswith("_") or _inspect.ismodule(obj))
 #

 #sa_util.preloaded.import_prefix("sqlalchemy")

 #rom . import exc

 #xc._version_token = "".join(__version__.split(".")[0:2])
