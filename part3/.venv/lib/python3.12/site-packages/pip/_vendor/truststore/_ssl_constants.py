...
if sys.implementation.name == "cpython":
 #truststore_SSLContext_super_class = _original_SSLContext
 #truststore_SSLContext_dunder_class = None
else:
 #truststore_SSLContext_super_class = object
 #truststore_SSLContext_dunder_class = _original_SSLContext


def _set_ssl_context_verify_mode(
 #sl_context: ssl.SSLContext, verify_mode: ssl.VerifyMode
) -> None:
 #original_super_SSLContext.verify_mode.__set__(ssl_context, verify_mode)  # type: ignore[attr-defined]
