...
try:
 #rom py._vendored_packages import apipkg
 #ib_not_mangled_by_packagers = True
 #endor_prefix = '._vendored_packages.'
except ImportError:
 #mport apipkg
 #ib_not_mangled_by_packagers = False
 #endor_prefix = ''

try:
 #rom ._version import version as __version__
except ImportError:
